...
// ── Products ────────────────────────────────────────────────
const products = [
  { id: 1, name: "Top Sereia", price: 89, cat: "tops", desc: "Top cropped com detalhes ondulados, perfeito para dias de sol", colors: ["#C2703E", "#E8D5B7"] },
  { id: 2, name: "Saia Mare", price: 109, cat: "saias", desc: "Saia midi fluida com textura artesanal e caimento leve", colors: ["#D4A59A", "#F5F0E8"] },
  { id: 3, name: "Vestido Lua", price: 119, cat: "vestidos", desc: "Vestido longo com trama aberta, ideal para o por do sol", colors: ["#E8D5B7", "#8A9A5B"] },
  { id: 4, name: "Cropped Sol", price: 79, cat: "tops", desc: "Cropped com amarracao nas costas, estilo praiano", colors: ["#C2703E", "#D4A59A"] },
  { id: 5, name: "Biquini Coral", price: 99, cat: "praia", desc: "Conjunto biquini em croche com acabamento premium", colors: ["#D4A59A", "#C2703E"] },
  { id: 6, name: "Saida de Praia Brisa", price: 99, cat: "praia", desc: "Saida de praia leve e transparente, trama aberta", colors: ["#F5F0E8", "#E8D5B7"] },
  { id: 7, name: "Bolero Flor", price: 89, cat: "tops", desc: "Bolero delicado com aplicacoes florais em croche", colors: ["#8A9A5B", "#E8D5B7"] },
  { id: 8, name: "Bolsa Areia", price: 69, cat: "acessorios", desc: "Bolsa de mao em croche com alca de couro natural", colors: ["#E8D5B7", "#3D2B1F"] },
];
...
// ── Product placeholder with crochet-inspired art ───────────
function ProductImage({ colors, name }) {
  return (
    <div style={{
      ...
      <div style={{ zIndex: 1, textAlign: "center" }}>
        <LogoIcon size={36} />
        <div style={{
          fontFamily: "'Caveat', cursive", fontSize: 14, color: C.primary,
      ...
      <section id="pecas" style={{ padding: "0 24px 80px", maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          {filteredProducts.map((product) => (
            ...
            >
              <ProductImage colors={product.colors} name={product.name} />
